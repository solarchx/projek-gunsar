        ...
        <form action="{{ route('dokter.store') }}" method="POST">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="nama_dokter" class="form-control" value="{{ old('nama_dokter') }}" required 
                           style="border-color: #3fbbc0; border-radius: 8px;">
            ...
            <div class="row mb-4">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="jabatan_dokter" class="form-control" value="{{ old('jabatan_dokter') }}" required 
                           style="border-color: #3fbbc0; border-radius: 8px;">

...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-5 border-bottom">
    <h1 class="h2" style="color: #3fbbc0;">Tambah Screening Baru</h1>
</div>
...
<div class="card shadow border-0" style="border-top: 3px solid #3fbbc0;">
    <div class="card-header py-3" style="background: linear-gradient(135deg, #3fbbc0 0%, #38a9ad 100%); color: white;">
        <h5 class="mb-0"><i class="fas fa-plus-circle me-2"></i>Form Tambah Screening</h5>
    </div>
    <div class="card-body">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('NIK_pasien') is-invalid @enderror" 
                               id="NIK_pasien" name="NIK_pasien" value="{{ old('NIK_pasien') }}" 
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('tanggal_screening') is-invalid @enderror" 
                               id="tanggal_screening" name="tanggal_screening" value="{{ old('tanggal_screening', date('Y-m-d')) }}">
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.1" class="form-control @error('suhu_badan') is-invalid @enderror" 
                               id="suhu_badan" name="suhu_badan" value="{{ old('suhu_badan') }}"
...
<script>
    ...
    document.getElementById('tanggal_screening').value = new Date().toISOString().substr(0, 10);
</script>
@endsection